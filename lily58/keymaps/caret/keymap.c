...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(test_combo2, KC_PGDOWN), // keycodes with modifiers are possible too!
};
...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_QUES, _______, _______, _______, _______, DF(_DVORAK), DF(_QWERTY), _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
